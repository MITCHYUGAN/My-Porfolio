    ...
    return(
        <div className={landingPage}>
            <div className={landingContents}>
                    ...
                    <h1 className={HtextClass}>Hi <span role="img" aria-label="A waving emoji">👋</span>, I'm Mitchyugan</h1>
            ...
            <div className={socials}>
                ...
                <div className={social}>
                    <a href="https://dev.to/rammcodes"  rel="noopener noreferrer" target="_blank">
